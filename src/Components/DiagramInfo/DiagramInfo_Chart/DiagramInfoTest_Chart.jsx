...
const DiagramInfoTest_Chart = ({ data, chartColor, Min, Max }) => {
  ...
  return (
    <div id='DiagramInfoTest_Chart' ref={chartRef} style={{ width: '100%', height: '80px', background: 'rgb(38, 55, 82)', boxShadow: '0px 0px 10px 2px rgb(22, 42, 69)', borderRadius: '10px', marginTop: '5px', backgroundColor: '#263752' }} />
  );
};
