...
import OverCurrentTrendBarChartDay from './OverCurrentTrendChart/OverCurrentTrendBarChartDay';
...
const OverCurrentTrendCurveDay = () => {
  ...
  // db에서 data를 받아오는 변수
  const { data: trendDataFromDb } = useTrendDataDay(selectedData);
        ...
        <Col span={8}>
          <div style={{ position: 'relative', height: '480px', margin: '20px 35px 0 35px', padding: 0, color: 'white', borderRadius: '8px' }} className='OverCurrentTrendCurve_Card'>
            <div className='logInfo'>
              <Col span={24}>
                <DiagramAlertStepDay TrendData={TrendData} selectedData={selectedData} selectedTimeUnit={selectedTimeUnit} />
              </Col>
            </div>
          </div>
        </Col>
