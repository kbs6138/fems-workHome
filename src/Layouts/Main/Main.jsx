                        ...
                        <Row>
                            <Col span={8}>
                                <div style={{ marginTop: '30px', marginLeft: '10px' }}>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100px" height="160px" viewBox="0 0 355.000000 553.000000" preserveAspectRatio="none">
                            ...
                            <Col span={8}>
                                <div style={{ marginTop: '30px', marginLeft: '30px' }}>
                                    <div style={{ position: 'absolute', top: '10%', left: '70%', transform: 'translate(-50%, -50%)' }}>
                                        <ThermometerComponent />
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100px" height="160px" viewBox="0 0 355.000000 553.000000" preserveAspectRatio="none">
                                        <g transform="translate(0.000000,553.000000) scale(0.100000,-0.100000)" fill="#FFFFFF" stroke="none">
                            ...
                            <Col span={8}>
                                <div style={{ marginTop: '30px', marginLeft: '40px' }}>
                                    <div style={{ position: 'absolute', top: '10%', left: '75%', transform: 'translate(-50%, -50%)' }}>
                                        <ThermometerComponent />
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100px" height="160px" viewBox="0 0 355.000000 553.000000" preserveAspectRatio="none">
                                        <g transform="translate(0.000000,553.000000) scale(0.100000,-0.100000)" fill="#FFFFFF" stroke="none">
